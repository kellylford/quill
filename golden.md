...
- **SHELL-3 (Todo):** the classic Explorer menu ships in SHELL-1; the Windows 11 `IExplorerCommand` modern-menu package and its installer registration require a real install/uninstall cycle and stay deferred. Tracks intake #113/#114/#116; macOS Finder (#115) stays blocked on the macOS port (#42).
